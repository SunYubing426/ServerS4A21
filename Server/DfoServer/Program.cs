...
namespace DfoServer
{
    internal class Program
    {
        ...
        private static readonly (string Arg, Func<int> Run)[] SelfTestRegistry =
        {
            ...
            ("--selftest-black-diamond-vending", SelfTests.BlackDiamondVendingSelfTest.Run),
            ("--selftest-black-diamond-fatigue-coin", SelfTests.BlackDiamondFatigueCoinSelfTest.Run),
            ("--selftest-black-diamond-secret-shop", SelfTests.BlackDiamondSecretShopSelfTest.Run),
            ("--selftest-black-diamond-card-coin", SelfTests.BlackDiamondCardCoinSelfTest.Run),
            ("--selftest-select-character-fatigue-ack", SelfTests.SelectCharacterFatigueAckSelfTest.Run),
