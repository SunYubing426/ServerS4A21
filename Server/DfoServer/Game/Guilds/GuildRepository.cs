...
DELETE FROM guild_warehouse_items WHERE guild_id=@gid;
DELETE FROM guild_member_attendance WHERE guild_id=@gid;
DELETE FROM guild_contract_claims WHERE guild_id=@gid;
DELETE FROM guild_contribution_events WHERE guild_id=@gid;
DELETE FROM guild_member_contributions WHERE guild_id=@gid;
DELETE FROM guild_contribution_periods WHERE guild_id=@gid;
DELETE FROM guild_contribution_rewards WHERE guild_id=@gid;
